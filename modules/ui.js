...
export function getStatusBackgroundClass(r) { const m = { 'common': 'rgba(224,224,224,0.1)', 'uncommon': 'rgba(79,172,246,0.1)', 'rare': 'rgba(93,76,192,0.1)', 'mythical': 'rgba(168,50,208,0.1)', 'legendary': 'rgba(217,70,239,0.1)', 'ancient': 'rgba(255,107,107,0.1)', 'ethereal': 'rgba(6,182,212,0.1)', 'immortal': 'rgba(251,191,36,0.1)' }; return m[r] || m['common']; }
